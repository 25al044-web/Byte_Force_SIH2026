    ...
    <div className="explanation-panel">
      ...
      <div className="exp-content">
        {explanations && explanations.length > 0 ? (
          <ul className="exp-list" aria-label="Risk score factors">
          ...
          <p className="exp-empty">
            No specific anomaly triggers recorded. All evaluation checks maintained baseline operational metrics.
          </p>
        )}
      </div>
